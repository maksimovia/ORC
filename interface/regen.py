...
class Window(QMainWindow):
    ...
    def calc(self):
        ...
        print(read_stream('COND-PUMP'))
        print(read_stream('HEAT-TURB'))
        print(read_stream('PUMP-REGEN'))
        print(read_stream('REGEN-HEAT'))
        print(read_stream('TURB-REGEN'))
        print(read_stream('REGEN-COND'))
