...
class Window(QMainWindow):
    def __init__(self):
        ...
        grid.addWidget(self.t_gas_input, 1, 0)
        grid.addWidget(self.p_gas_input, 2, 0)
        grid.addWidget(self.g_gas_input, 3, 0)
        grid.addWidget(self.x_gas_input, 4, 0)
        grid.addWidget(self.t_gas_out_input, 5, 0)

        grid.addWidget(self.t_cool_input, 1, 1)
        grid.addWidget(self.p_cool_input, 2, 1)
        grid.addWidget(self.g_cool_input, 3, 1)
        grid.addWidget(self.x_cool_input, 4, 1)

        grid.addWidget(self.t_cond_input, 1, 2)
        grid.addWidget(self.fluid_input, 2, 2)
        grid.addWidget(self.p_pump_input, 3, 2)
        grid.addWidget(self.kpd_pump_input, 4, 2)
        grid.addWidget(self.kpd_turb_input, 5, 2)
        grid.addWidget(self.dt_heat_input, 6, 2)
        grid.addWidget(self.dt_cond_input, 7, 2)
        grid.addWidget(self.cycle_tolerance_input, 8, 2)

        grid.addWidget(self.img, 0, 0)
        grid.addWidget(self.start_button, 3, 3)
        grid.addWidget(self.kpd_output, 2, 3)
        grid.addWidget(self.time_lbl, 1, 3)
        grid.addWidget(self.graph_balance, 0, 3)
        ...
        grid.addWidget(calc_status_container)
